...
var utils = require('@swiftcarrot/utils');
...
var Popover = function Popover(_ref) {
  ...
  React.useEffect(function () {
    if (!popoverId) {
      return setIds({
        popoverId: utils.uid('popover'),
        referenceId: utils.uid('reference'),
        arrowId: utils.uid('arrow')
      });
    }
  ...
  return core.jsx(React.Fragment, null, popoverId ? core.jsx("div", _extends({}, props, {
    id: popoverId,
    ref: popover,
    css: styles.content,
    style: visible ? {
    ...
    css: styles.header
  }, header) : null, core.jsx("div", {
    css: styles.body
  }, body)) : null, React__default.cloneElement(child, _extends({}, child.props, {
    id: referenceId,
    onClick: handleClick
  })));
};
